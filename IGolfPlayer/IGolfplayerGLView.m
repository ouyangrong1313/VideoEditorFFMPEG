...
- (void) setFrame: (IGVideoFrame *) frame;
- (BOOL) prepareRender;
@end
...
- (void) setFrame: (IGVideoFrame *) frame
{
    IGVideoFrameYUV *yuvFrame = (IGVideoFrameYUV *)frame;
...
@implementation IGolfplayerGLView {
             ...
             decoder: (IGolfplayerDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:IGVideoFrameFormatYUV]) {
