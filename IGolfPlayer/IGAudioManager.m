...
@interface IGAudioManagerImpl : IGAudioManager<IGAudioManager> {
...
{
    static IGAudioManagerImpl *audioManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        audioManager = [[IGAudioManagerImpl alloc] init];
    });
    return audioManager;
}
...
@implementation IGAudioManagerImpl
...
static void sessionPropertyListener(void *                  inClientData,
                                    ...
                                    const void *            inData)
{
    IGAudioManagerImpl *sm = (__bridge IGAudioManagerImpl *)inClientData;
...
{
	IGAudioManagerImpl *sm = (__bridge IGAudioManagerImpl *)inRefCon;
